...
export default function PixelSnow({
  ...
  const [isReady, setIsReady] = useState(false); // 新增：控制显示状态
  ...
  // Props are used in initial setup but updated via separate effect below
  ...
  return (
    <div
      ref={containerRef}
      className={`absolute inset-0 w-full h-full transform-gpu transition-opacity duration-700 ${
